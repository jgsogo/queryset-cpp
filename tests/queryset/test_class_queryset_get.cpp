...
typedef std::tuple<std::size_t, std::string, float> MyModelTuple;
typedef ::qs::MemoryDataSource<MyModelTuple, std::size_t, std::string, float> myDataSource;
//typedef std::tuple<std::size_t, std::string, float> mytuple;

struct FixtureGet {
    FixtureGet() {
        initial_qs >> MyModelTuple{ 0, "hola", 0.f };
        initial_qs >> MyModelTuple{ 1, "bye", 0.1f };
        initial_qs >> MyModelTuple{ 2, "ciao", 0.2f };

        initial_qs >> MyModelTuple{ 3, "hola", 1.f };
        initial_qs >> MyModelTuple{ 4, "bye", 1.1f };
        initial_qs >> MyModelTuple{ 5, "ciao", 1.2f };

        initial_qs >> MyModelTuple{ 6, "hola", 2.f };
        initial_qs >> MyModelTuple{ 7, "bye", 2.1f };
        initial_qs >> MyModelTuple{ 7, "ciao", 2.2f };
    }
    ~FixtureGet() {}
...
{
    QuerySet<MyModelTuple, std::size_t, std::string, float> qs(initial_qs);
    auto t0 = qs.get(0);
